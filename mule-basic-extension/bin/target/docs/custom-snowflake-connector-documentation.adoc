:toc:               left
:toc-title:         Custom Snowflake Connector Connector
:toclevels:         2
:last-update-label!:
:docinfo:
...
= Custom Snowflake Connector Connector Documentation Reference
...
|======================
| Name | Type | Description | Default Value | Required
| Configuration Detail a| <<CustomSnowFlakeConfiguration>> |  +++A parameter that is always required to be configured.+++ |  | *x*{nbsp}
...
[[executeQuery]]
=== Execute Query
`<custom-snowflake:execute-query>`
...
==== Throws
* CUSTOM-SNOWFLAKE:CONNECTIVITY {nbsp}
* CUSTOM-SNOWFLAKE:RETRY_EXHAUSTED {nbsp}



== Types
[[CustomSnowFlakeConfiguration]]
=== Custom Snow Flake Configuration

[cols=".^20%,.^25%,.^30%,.^15%,.^10%", options="header"]
|======================
| Field | Type | Description | Default Value | Required
| User a| String |  |  | x
| Client Id a| String | A parameter that is always required to be configured. |  | x
| Client Secret a| String |  |  | x
| Scope a| String |  |  | x
| Account a| String |  |  | x
| Warehouse a| String |  |  | x
| Database a| String |  |  | x
| Schema a| String |  |  | x
| Multi Statement Count a| Number |  |  | x
|======================
